      ...
      <div className="mx-auto mt-16 grid max-w-6xl grid-cols-1 gap-y-8 sm:mt-20 lg:grid-cols-3 gap-10">
        {tiers.map((tier) => {
          ...
          return (
            ...
            >
              {/* Plan Header Section */}
              <div className="bg-orange-100 p-8 sm:p-10 text-center lg:text-left">
                <h2 className="text-orange-600 text-3xl font-semibold">
                  {tier.name}
                </h2>

                <p className="mt-4 flex items-baseline gap-x-2 justify-center lg:justify-start">
...
//   // Pricing data fetched from i18next JSON
//   const tiers = [
//     {
//       id: "tier-basic",
//       href: "#contact",
...
//               onTouchStart={() => setHovered((prev) => !prev)} // ✅ Tap hover for mobile
//               className={`flex flex-col justify-between bg-white border border-amber-400 rounded-3xl 
//               p-8 sm:p-10 transition-all duration-500 transform 
//               ${
//                 hovered
//                   ? "scale-105 shadow-xl shadow-orange-300"
//                   : "scale-100 shadow-sm"
...
//               {/* Plan Info */}
//               <div>
//                 <h3 className="text-orange-500 text-base font-semibold">
//                   {tier.name}
//                 </h3>

//                 <p className="mt-4 flex items-baseline gap-x-2 justify-center lg:justify-start">
//                   <span className="text-3xl md:text-4xl font-semibold tracking-tight text-gray-900">
//                     {tier.price}
//                   </span>
//                 </p>
...
//                 {/* Features */}
//                 <ul className="mt-8 space-y-3 text-sm text-gray-600 text-start">
//                   {tier.features.map((feature) => (
